...
public:
	...
	GameObject* GetGameObject(const CellPosition& position);// Gets a Pointer to the the passed "position" if it is a card
	// ========= User Interface Functions =========

	void ResetPlayers();         // new function to clear players 
	...
	// ========= Bonus Functions =========
	void Icedpower(int i);
	void Firedpower(int i);
	void Poisonedpower(int i);
	void Lightening();
